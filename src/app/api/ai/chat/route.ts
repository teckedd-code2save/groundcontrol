        ...
        try {
          ...
          if (incidentContext) {
            ...
            parts.unshift(
              ...
              `Proxy upstream: ${incidentContext.proxyUpstream || "unresolved"}\n` +
              `Runtime status: ${incidentContext.runtimeStatus || "unresolved"}\n` +
              `Containers: ${(incidentContext.containers || []).join(", ") || "unresolved"}\n` +
              `Compose services: ${(incidentContext.composeServices || []).join(", ") || "unresolved"}\n\n` +
